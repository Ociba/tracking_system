  ...
  <div class="content-wrapper">
    ...
    <div class="card">
            ...
            <div class="form-group">
                ...
                <form class="">
                        <div class="input-group ">
                          <input class="form-control" type="search" placeholder="Search Group" aria-label="Search">
                ...
                <div class="col-4">
                <a href="/add-group" button type="button" class="btn btn-primary">Add Group</button></a>
                </div>
                </div>
