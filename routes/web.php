...
Route::get('/login-section', function (){
    return view('before_login.login-page');
});
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/user','ChurchUserController@show')->name('Users');
    ...
    Route::get('/sent-quick-messages','messages@drop_down_groups')->name('Send Quick Messages');
    ...
    Route::get('/addusers','ChurchUserController@displayUsersForm')->name('Add User Form');
    Route::get('/contacts',function() { return view('after_login.contacts');});
    Route::get('/manager',function() { return view('after_login.manager');});
    Route::get('/create-TIG-groups','ChurchesController@displayAddChurchForm')->name('Create Church');
    ...
    Route::get('/create-group-form','GroupsController@show_form')->name('Create Contact Group Form');
    ...
    Route::get('/change-passwords',"ChurchUserController@displayChangePasswordForm")->name('Change Password');
    ...
    Route::get('/incoming-messages','messages@show_incoming_messages')->name('Incoming Messages');
    Route::get('/edit-category-term/{id}','messages@edit_message_category');
    Route::get('/add-search-term/{id}','messages@display_message_category_form')->name('All Search Terms');
    ...
    Route::get('/addnewsubscription','PackagesController@selectSubscribedForMessagesTitle')->name('Add New Subscription Form');
    ...
    Route::get('/uncategorized-messages','messages@showUnCategorizedMessages')->name('Uncategorized Messages');
    ...
    Route::get('/add-category-contacts/{id}','CategoriesController@addContacts')->name('Add Category Form');
